...
%{
lncSim = load('Dataset-7\seqsimilarity .csv');   %lncRNA 表达相似性
disSim = load('Dataset-7\dissimilarity .csv');  % disease 语义相似性
interaction = load('Dataset-7\chr_diseasematrix .csv');
%}
